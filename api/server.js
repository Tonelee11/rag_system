...
// ── Rate limiting — 10 requests per 10 min per IP ─────────────
...
// ── API key middleware — only for admin routes ─────────────────
...
// ── Routes ─────────────────────────────────────────────────────
// Chat is public — protected by CORS + rate limiting only
...
app.listen(PORT, () => {
  ...
  console.log("  Auth:    CORS + rate limiting (no key required)");
  console.log("========================================\n");
});